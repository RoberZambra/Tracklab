...
// Helper: detecta mobile para ajustes de UI
  ...
  const chartOpts = (label, unit) => ({
    ...
    options: {
      ...
      scales: {
        ...
        y: {
          display: true,
          ticks: { color: 'rgba(255,255,255,0.2)', font: { family: 'Fira Code', size: 11 }, maxTicksLimit: 4 },
      ...
      scales: {
        x: {
          ...
          title: {
            ...
            color: 'rgba(255,255,255,0.2)', font: { family: 'Fira Code', size: isMobile() ? 11 : 12 },
          },
...
// ──────────────────────────────────────────────────────
// RESPONSIVIDADE — redimensiona gráficos ao girar tela
// ──────────────────────────────────────────────────────
